...
public class ItemManagement extends javax.swing.JInternalFrame {
     ...
     */
    public ItemManagement(User currentUserInfo, JDesktopPane desktopPane) throws SQLException {
        initComponents();
    ...
    public void filter() throws SQLException {
        ...
        this.allItems = itemController.getAllItems(newStoreId.substring(0, newStoreId.indexOf(" - ")), searchInput.getText());
    ...
    private void populateTable() throws SQLException {
        ...
        for (Item item : allItems) {
            ...
            String distributorName = Integer.toString(item.getId_distributor()) + " - " + distributorController.distributorName(Integer.toString(item.getId_distributor()));
            ...
            model.addRow(new Object[]{
                ...
                item.getKolicina(),
                item.getPopust(),
                item.getCijena_nabavke(),
                item.getCijena_prodaje()
            });
        }
            ...
            jTable1.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (e.getClickCount() == 2) {
                        ...
                        try {
                            itemDetails = new ItemDetails(Integer.toString((int) rowData[0]),
                                    newStoreId.substring(0, newStoreId.indexOf(" - ")), currentUserPrivilege);
                        } catch (SQLException ex) {
                            JOptionPane.showMessageDialog(rootPane, "Greška tokom pribavljanja podataka.", "Greška", JOptionPane.ERROR_MESSAGE);
                        }
                        desktopPane.add(itemDetails).setVisible(true);
                        Dimension desktopSize = desktopPane.getSize();
                        Dimension jInternalFrameSize = itemDetails.getSize();
                        itemDetails.setLocation((desktopSize.width - jInternalFrameSize.width) / 2, 32);
                    }
                }
            });
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pretraživanje artikala");
        ...
        jLabel2.setText("U tabeli su prikazani podaci o artiklima, za detaljan pregled kliknite podatak dva puta...");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Naziv", "Distributer", "Količina", "Popust", "Nabavna cijena", "Prodajna cijena"
            }
        ) {
