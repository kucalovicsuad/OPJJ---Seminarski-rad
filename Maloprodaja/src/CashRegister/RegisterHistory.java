 ...
 */
public class RegisterHistory extends javax.swing.JInternalFrame {

    private final String currentUserId;
    private final String currentUserPrivilege;
    private final String storeId;
    private ArrayList<Register> allRegisters = new ArrayList<>();
     ...
     */
    public RegisterHistory(String currentUserId, String currentUserPrivilege) throws SQLException {
        initComponents();
        this.currentUserId = currentUserId;
        this.currentUserPrivilege = currentUserPrivilege;
        this.storeId = userController.storeId(currentUserId);
    ...
    public void filter() throws SQLException {
        ...
        this.allRegisters = registerController.getAllRegisters(newStoreId.substring(0, newStoreId.indexOf(" - ")), currentUserId, currentUserPrivilege, searchInput.getText());
    ...
    private void populateTable() throws SQLException {
        ...
        for (Register register : allRegisters) {
            ...
            String user_opening = Integer.toString(register.getId_zaposlenik_otvaranja()) + " - " + userController.userNameAndSurname(Integer.toString(register.getId_zaposlenik_otvaranja()));
            String user_closing;

            if (register.getId_zaposlenik_zatvaranja() == 0) {
                user_closing = " - ";
            } else {
                user_closing = Integer.toString(register.getId_zaposlenik_zatvaranja()) + " - " + userController.userNameAndSurname(Integer.toString(register.getId_zaposlenik_zatvaranja()));
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pretraživanje historije kase");
        ...
        jLabel2.setText("U tabeli su prikazani podaci o historiji kase...");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Datum", "Otvoreno", "Depozit", "Otvorio", "Zatvoreno", "Zatvorio", "Promet"
            }
        ) {
